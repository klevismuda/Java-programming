...
public class ElectricCar {
    ...
    public ElectricCar(String make, String model, double price, int year, int range) {
        setMake(make); // they are the same, useful when setter has some condition
                       // reuse the code in the setter
        this.model = model;
        this.price = price;
        this.year = year;
        this.range = range;
        count++;  //increase count by 1 - everytime new car is added
    }

    public final void charge(){
        System.out.println("Charging the Electric car, put it in plugin");
